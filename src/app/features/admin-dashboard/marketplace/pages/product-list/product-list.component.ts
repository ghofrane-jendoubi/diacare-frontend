...
export class ProductListComponent implements OnInit {
  ...
  getAlimentairePercentage(): number {
    return this.totalProducts > 0 ? (this.alimentaireCount / this.totalProducts * 100) : 0;
  }

  getMedicalPercentage(): number {
    return this.totalProducts > 0 ? (this.medicalCount / this.totalProducts * 100) : 0;
  }

  getLowStockPercentage(): number {
    return this.totalProducts > 0 ? (this.lowStockCount / this.totalProducts * 100) : 0;
  }
